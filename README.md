...
- SDL多线程
    ...
    - SDL互斥锁SDL_CreateMutex/SDL_DestroyMutex；
    ...
    - SDL锁定互斥SDL_LockMutex/SDL_UnlockMutex；
    ...
    - SDL条件变量（信号量）等待/通知SDL_CondWait/SDL_CondSignal；
